...
<div id="topbar" class="d-flex align-items-center fixed-top">
  ...
  <div class="welcome2">
    ...
    <p>
        <a href="index1.php" class="btn btn-warning">Manager system</a>
        <a href="index.php" class="btn btn-warning">Shopping cart</a>
        <a href="reset-password.php" class="btn btn-warning">Reset Your Password</a>
        <a href="logout.php" class="btn btn-danger ml-3">Sign Out of Your Account</a>
        <a href="index.html" class="btn btn-danger ml-3">Go back to the homepage</a>
    </p>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>LiuJiayuan</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
