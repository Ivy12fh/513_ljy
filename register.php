...
$Id=$username = $password = $confirm_password  = $phone=$address=$city =$email = "";
$Id_err =$username_err = $password_err = $confirm_password_err  =$phone_err = $address_err= $city_err= $email_err ="";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)&& empty($phone_err)&& empty($address_err)&& empty($city_err)&& empty($email_err)){
        
        // Prepare an insert statement
        $sql = "INSERT INTO customers (Id,username, password,phone,address,city,email) VALUES (?,?,?,?,?,?,?)";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ississs",$param_Id, $param_username, $param_password,$param_phone,$param_address,$param_city,$param_email);
  ...
  <header id="header" class="fixed-top d-flex align-items-cente">
    ...
    <div class="wrapper2">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                <label>Address</label>
                <input type="text" name="address" class="form-control <?php echo (!empty($email_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $address; ?>">
